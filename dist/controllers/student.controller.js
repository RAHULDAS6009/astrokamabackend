...
export const studentController = {
    ...
    createStudent: async (req, res) => {
        try {
            const { name, email, password, branchId, gurdianName, relationWithGurdain, courseMode, courseDetails, communicationAddress, permanentAddress, mobileNumber, gender, whatsappNumber, dateOfBirth, placeOfBirth, educationalQualification, extraExperience, astrologicalExperience, occupation, photoUrl, certificateUrl, idProofUrl, razorpayPaymentId, razorpayOrderId, razorpaySignature, } = req.body;
            // ============================
    ...
    getStudyMaterials: async (req, res) => {
        try {
            ...
            const semesterMaterials = student.branch?.semsters.flatMap((s) => s.studyMaterial) || [];
            res.json({
                success: true,
