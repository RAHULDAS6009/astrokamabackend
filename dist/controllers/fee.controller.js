...
export const feeController = {
    ...
    createOrder: async (req, res) => {
        try {
            ...
            const semesterExists = student.branch?.semsters?.some((sem) => sem.id === semesterId);
            if (!semesterExists) {
    ...
    verifyPayment: async (req, res) => {
        try {
            ...
            const { razorpay_payment_id, razorpay_order_id, razorpay_signature, semesterId, amount, description, lateFine = 0, } = req.body;
            // Validation
