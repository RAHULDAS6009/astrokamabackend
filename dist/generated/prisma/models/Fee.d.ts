...
export type FeeWhereInput = {
    ...
    year?: Prisma.IntFilter<"Fee"> | number;
...
export type FeeScalarWhereWithAggregatesInput = {
    ...
    year?: Prisma.IntWithAggregatesFilter<"Fee"> | number;
...
export type FeeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "studentId" | "month" | "year" | "amount" | "status" | "createdAt", ExtArgs["result"]["fee"]>;
...
export interface FeeFieldRefs {
    ...
    readonly year: Prisma.FieldRef<"Fee", 'Int'>;
