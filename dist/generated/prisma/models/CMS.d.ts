...
export type GetCMSAggregateType<T extends CMSAggregateArgs> = {
    [P in keyof T & keyof AggregateCMS]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateCMS[P]> : Prisma.GetScalarType<T[P], AggregateCMS[P]>;
};
...
type GetCMSGroupByPayload<T extends CMSGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<CMSGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof CMSGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], CMSGroupByOutputType[P]> : Prisma.GetScalarType<T[P], CMSGroupByOutputType[P]>;
}>>;
...
export type CMSCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<CMSFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CMSDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends CMSCountArgs>(args?: Prisma.Subset<T, CMSCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], CMSCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends CMSGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, CMSGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCMSGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
