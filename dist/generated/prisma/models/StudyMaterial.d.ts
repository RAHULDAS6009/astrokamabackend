...
export type GetStudyMaterialAggregateType<T extends StudyMaterialAggregateArgs> = {
    [P in keyof T & keyof AggregateStudyMaterial]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateStudyMaterial[P]> : Prisma.GetScalarType<T[P], AggregateStudyMaterial[P]>;
};
...
type GetStudyMaterialGroupByPayload<T extends StudyMaterialGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<StudyMaterialGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof StudyMaterialGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], StudyMaterialGroupByOutputType[P]> : Prisma.GetScalarType<T[P], StudyMaterialGroupByOutputType[P]>;
}>>;
export type StudyMaterialWhereInput = {
    ...
    batchId?: Prisma.IntFilter<"StudyMaterial"> | number;
...
export type StudyMaterialScalarWhereWithAggregatesInput = {
    ...
    id?: Prisma.IntWithAggregatesFilter<"StudyMaterial"> | number;
    ...
    batchId?: Prisma.IntWithAggregatesFilter<"StudyMaterial"> | number;
...
export type StudyMaterialOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "type" | "url" | "batchId" | "createdAt", ExtArgs["result"]["studyMaterial"]>;
...
export type StudyMaterialCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<StudyMaterialFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface StudyMaterialDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends StudyMaterialCountArgs>(args?: Prisma.Subset<T, StudyMaterialCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], StudyMaterialCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends StudyMaterialGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, StudyMaterialGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetStudyMaterialGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface StudyMaterialFieldRefs {
    readonly id: Prisma.FieldRef<"StudyMaterial", 'Int'>;
    ...
    readonly batchId: Prisma.FieldRef<"StudyMaterial", 'Int'>;
